	...
	testCases := []struct {
		...
		},
		{
				...
				KubeProxyReplacement: &models.KubeProxyReplacement{
					Features: &models.KubeProxyReplacementFeatures{
						Annotations: []string{
							...
							"No-eBPF CiliumNetworkPolicy / CiliumClusterwideNetworkPolicy: supported-subset (L3/L4 allow rules, selectors, named ports, endPort, and ipBlock)",
			...
			expectedContains: []string{
				...
				"CiliumNetworkPolicy / CiliumClusterwideNetworkPolicy: supported-subset (L3/L4 allow rules, selectors, named ports, endPort, and ipBlock)",
